...
class JsonRepository(Repository):
    ...
    def read(self, id_entity: object = None) -> Type[
        Union[Optional[Entity],
              List[Entity]]]:
        """
        TODO
    ...
    def update(self, entity: Entity) -> None:
        ...
        entities = self.__read_file()
        id = f'{entity.id_entity}'
        if self.read(id) is None:
            msg = f'Nu exista o entitate cu id-ul {id} de actualizat.'
